...
syntax region nowebTT   start="\[\["hs=s+2 end="\]\]"he=e-2 
syntax region nowebXX   start="|"hs=s+1 end="|"he=e-1 
syntax region nowebName start="<<" end=">>" oneline contains=nowebTT
