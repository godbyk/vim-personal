...
"
" Based heavily on code from Derek Wyatt <http://derekwyatt.org>
"

" Use clang++ for code completion
let g:clang_exec = "clang++"

" OmniCppComplete initialization
"call omni#cpp#complete#Init()

"source ~/.vim/syntax/opengl.vim " Syntax highlighting for OpenGL
"let OmniCpp_NamespaceSearch = 1 " search namespaces in the current buffer and in included files
"let OmniCpp_LocalSearchDecl = 1 " use local search function

" search these namespaces by default
"let OmniCpp_DefaultNamespaces = ["std"]

" close preview window after you've moved the cursor
autocmd CursorMovedI * if pumvisible() == 0|pclose|endif
autocmd InsertLeave * if pumvisible() == 0|pclose|endif

" C and C++ tags to autocomplete
"set tags+=~/.vim/tags/system " tag file resulting from: ctags -R --c++-kinds=+p --fields=+iaS --extra=+q --language-force=C++ /usr/include /usr/local/include
set tags+=~/svn/greenspace/trunk/src/tags
set tags+=~/.vim/tags/sgi_stl.tags
set tags+=~/.vim/tags/vrjuggler.tags
set tags+=~/.vim/tags/ftdi.tags
set tags+=~/.vim/tags/opensg.tags
set tags+=~/.vim/tags/sgi_stl.tags
...
if has("gui_running")
    ...
    let darkerbg = synIDattr(synIDtrans(hlID("Normal")), "bg")
end
...
"
let g:protodefprotogetter = '/usr/bin/perl ~/.vim/bundle/ProtoDef/pullproto.pl'
...
augroup local_ftplugin_cpp
    ...
    autocmd BufEnter *.h let b:fswitchdst = 'cpp,c' | let b:fswitchlocs = 'reg:/include/src/,reg:/include.*/src/,ifrel:|/include/|../src|,./'
    autocmd BufEnter *.c,*.cpp let b:fswitchdst = 'h' | let b:fswitchlocs = 'reg:/src/include/,reg:|src|include/**|,ifrel:|/src/|../include|,./'
augroup END
